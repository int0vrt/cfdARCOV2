...
Eigen::Matrix<float, -1, 1> boundary_none(Mesh2D* mesh, Eigen::Matrix<float, -1, 1>& arr) {
    return arr;
}
...
Eigen::Matrix<float, -1, 1> boundary_with_neumann_pressure(Mesh2D* mesh, Eigen::Matrix<float, -1, 1>& arr, Eigen::Matrix<float, -1, 1>& copy_var) {
